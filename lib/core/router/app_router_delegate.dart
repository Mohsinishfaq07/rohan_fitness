...
import 'package:sb_myreports/features/google_map/presentation/pages/map_screen.dart';
import 'package:sb_myreports/features/jokes/presentation/pages/joke_screen.dart';
import 'package:sb_myreports/features/jokes/presentation/pages/jokes_list_screen.dart';
  ...
  void addPage(PageConfiguration pageConfig) {
    ...
    if (shouldAddPage) {
      switch (pageConfig.uiPage) {
        ...
        case Pages.jokesListPage:
          _addPageData(JokeListScreen(), pageConfig);
          break;

        case Pages.googleMapPage:
          _addPageData(GoogleMapScreen(), pageConfig);
          break;
      }
    }
  }
